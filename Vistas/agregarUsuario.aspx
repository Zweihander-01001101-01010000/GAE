<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agregarUsuario.aspx.cs" Inherits="GAE.Vistas.agregarUsuario" %>
...
<label class="fuente-morada" for="horario">Departamento</label>
        ...
        <label class="fuente-morada" for="colaboradorACargo">Rol</label>
        <asp:DropDownList ID="rolUsuario" runat="server">
            <asp:ListItem Text="Seleccione" Value="" />
        </asp:DropDownList>
