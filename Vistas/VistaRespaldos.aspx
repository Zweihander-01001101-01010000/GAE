<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VistaRespaldos.aspx.cs" Inherits="GAE.Vistas.VistaRespaldos" %>
        ...
        <main>
            <section class="seccion-formulario">
                <div class="tarjeta-formulario">
                    <h2>Carpeta</h2>
                    <asp:DropDownList ID="ddlRespaldos" runat="server"></asp:DropDownList>
                    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Mostrar archivos de respaldo" />
                </div>
