<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="agregarDepartamento.aspx.cs" Inherits="GAE.Vistas.agregarDepartamento" %>
      ...
      <li><a href="agregarUsuario.aspx">Añadir Usuario</a></li>
        ...
        <div class="tarjeta-formulario" style="max-width: 700px; margin: 0 auto;">
           ...
           <asp:Button ID="ingresar" runat="server" Text="Ingresar" CssClass="button" OnClick="ingresar_Click" />
            ...
            <br />
            <asp:Button ID="volverMenu" runat="server" Text="Volver al menú" CssClass="button-blanco"  />
        </div>
    </section>
